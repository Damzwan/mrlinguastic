  ...
  <div>
    ...
    <div class="row">
      <div class="col offset-m2 offset-s1 s10 m8 center">
        ...
        <p class="flow-text">
          Instead of wasting time searching for good sources for every subject individually, we would like to create a
        ...
        <p class="flow-text">We strongly believe in <b>free</b> education! We hope to create an ad-free website with
    ...
    <div class="row">
      <div class="col offset-s3 s6 offset-m3 m2">
      ...
      <div class="col offset-s3 s6 offset-m2 m2">
